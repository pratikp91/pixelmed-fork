...
public class AttributeList extends TreeMap<AttributeTag,Attribute> {
	...
	/***/
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/dicom/AttributeList.java,v 1.124 2013/09/18 15:42:35 dclunie Exp $";
...
//System.err.println("AttributeList.checkSanityOfValueLength(): vr = "+ValueRepresentation.getAsString(vr)+" vl = "+vl);
		...
		if (vl > maximumShortVRValueLength && ValueRepresentation.isShortValueLengthVR(vr)) {
			if (!tag.equals(TagFromName.DVHData) && !tag.equals(TagFromName.HistogramData)) {
	...
	protected static boolean decompressPixelData = true;
...
//System.err.println("Starting frame "+f);
										...
										IIOImage iioImage = reader.readAll(0,null/*ImageReadParam*/);
										if (iioImage == null) {
